...
<div id="main">
  ...
  <h1><i>Books Returns</i></h1>
                        <table class="table" id = "tables">
                                  ...
                                  <tbody>
                                    <?php
                            $sql="select return.BookId,return.RollNo,Title,datediff(curdate(),Due_Date) as x from LMS.return,LMS.book,LMS.record where return.BookId=book.BookId and return.BookId=record.BookId and record.RollNo=return.RollNo and return.RollNo ='$roll'";
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center>
                                        ...
                                        <a href="acceptreturn.php?id1=<?php echo $bookid; ?>&id2=<?php echo $rollno; ?>&id3=<?php echo $dues ?>" class="btn btn-outline-success">Accept</a>
                                         
                                        <a href="reject.php?id1=<?php echo $bookid; ?>&id2=<?php echo $rollno; ?>" class="btn  btn-outline-danger">Reject</a>
                                    </center></td>
                                    </tr>
                               <?php } ?>
                               </tbody>
