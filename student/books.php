...
<section class="p-5 text-center Booksa" id="Books">    <!--p5 ile padding değeri verdim-->
...
<form class="form-horizontal row-fluid" action="books.php" method="post">
                        ...
                        <table class="table" id = "tables">
                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><center><a href="bookdetails.php?id=<?php echo $bookid; ?>" class="btn btn-outline-info">Details</a>
                                      <?php
                                      	if($avail > 0)
                                      		echo "<a href=\"add.php?id=".$bookid."\" class=\"btn btn-outline-secondary\">Add</a>";
                                        ?>
